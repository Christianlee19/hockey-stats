...
## create df with info
urls = c("http://www.nhl.com/stats/teams?aggregate=0&reportType=game&seasonFrom=20172018&seasonTo=20192020&dateFromSeason&gameType=2&filter=gamesPlayed,gte,1&sort=a_gameDate&page=0&pageSize=100",
            "http://www.nhl.com/stats/teams?aggregate=0&report=faceoffpercentages&reportType=game&seasonFrom=20172018&seasonTo=20192020&dateFromSeason&gameType=2&filter=gamesPlayed,gte,1&sort=a_gameDate&page=0&pageSize=100",
            "http://www.nhl.com/stats/teams?aggregate=0&report=realtime&reportType=game&seasonFrom=20172018&seasonTo=20192020&dateFromSeason&gameType=2&filter=gamesPlayed,gte,1&sort=a_gameDate&page=0&pageSize=100",
            "http://www.nhl.com/stats/teams?aggregate=0&report=penalties&reportType=game&seasonFrom=20172018&seasonTo=20192020&dateFromSeason&gameType=2&filter=gamesPlayed,gte,1&sort=a_gameDate&page=0&pageSize=100",
            "http://www.nhl.com/stats/teams?aggregate=0&report=percentages&reportType=game&seasonFrom=20172018&seasonTo=20192020&dateFromSeason&gameType=2&filter=gamesPlayed,gte,1&sort=a_gameDate&page=0&pageSize=100")
